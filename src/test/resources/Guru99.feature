Feature: Guru99 Test cases
  ...
  Scenario: Verify Login message in Guru99
    ...
    When The user wants to enter username as "askslkjs" and password as "adsdsa"
  ...
  Scenario: Verify Account message
    Given The user wants to go to guru99
    When The user wants to username as "1303" and password as "Guru9"
    Then The user wants to see Mini Statement
    Then The user wants to see account number as "330"
